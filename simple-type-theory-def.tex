...
\newcommand{\IsDefApp}{{\downarrow}}
\newcommand{\IsUndefApp}{{\uparrow}}
...
\newcommand{\wrestricted}{\mbox{$|$}\nolinebreak}
\newcommand{\srestricted}{\mbox{$\upharpoonright$}\nolinebreak}
...
\ifdefined \proof
  \renewenvironment{proof}[1][\unskip]{\par\noindent{\bf Proof{#1}\dblsp}}{\hfill$\Box$}
\else
  \newenvironment{proof}[1][\unskip]{\par\noindent{\bf Proof{#1}\dblsp}}{\hfill$\Box$}
\fi
\newenvironment{proofsketch}[1][\unskip]{\par\noindent{\bf Proof sketch{#1}\dblsp}}{\hfill$\Box$}
